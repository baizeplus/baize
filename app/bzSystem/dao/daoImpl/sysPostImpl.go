...
func (postDao *SysPostDao) SelectPostAll(ctx context.Context, db sqly.SqlyContext) (sysPost []*models.SysPostVo) {
	sysPost = make([]*models.SysPostVo, 0)
...
func (postDao *SysPostDao) SelectPostList(ctx context.Context, db sqly.SqlyContext, post *models.SysPostDQL) (list []*models.SysPostVo, total *int64) {
	whereSql := ``
	if post.PostCode != "" {
...
func (postDao *SysPostDao) SelectPostById(ctx context.Context, db sqly.SqlyContext, postId int64) (dictData *models.SysPostVo) {

	dictData = new(models.SysPostVo)
...
func (postDao *SysPostDao) InsertPost(ctx context.Context, db sqly.SqlyContext, post *models.SysPostVo) {
...
func (postDao *SysPostDao) UpdatePost(ctx context.Context, db sqly.SqlyContext, post *models.SysPostVo) {
