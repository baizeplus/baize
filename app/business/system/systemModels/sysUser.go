...
type SysUserDQL struct {
	...
	DeptId      string `form:"deptId" db:"dept_id"`          //部门ID
	baize.BaseEntityDQL
}

type SysUserDML struct {
	UserId      string   `json:"userId" db:"user_id"swaggerignore:"true"`    //用户ID
	DeptId      string   `json:"deptId" db:"dept_id" binding:"required"`     //部门ID
...
type ResetPwd struct {
	UserId   string `json:"userId" db:"user_id" binding:"required"`    //用户ID
