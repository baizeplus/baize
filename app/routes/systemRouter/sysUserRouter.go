...
func InitSysUserRouter(router *gin.RouterGroup, userController *controller.UserController) {
	...
	systemUser.DELETE("", middlewares.HasPermission("system:user:remove"), userController.UserRemove)
